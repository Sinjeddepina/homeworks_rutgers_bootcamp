...
predictions_df[['Actual Returns', 'Strategy Returns']].plot(figsize=(10, 6))
...
# Add the actual returns to the DataFrame
predictions_df_rf['Actual Returns'] = signals_df.loc[X_test.index, 'Actual Returns']
...
display(predictions_df_rf.tail())

# Plot the actual returns versus the strategy returns
predictions_df_rf[['Actual Returns', 'Strategy Returns']].plot(figsize=(10, 6))
plt.title("Actual Returns vs. Strategy Returns")
plt.xlabel("Date")
plt.ylabel("Returns")
plt.legend()
